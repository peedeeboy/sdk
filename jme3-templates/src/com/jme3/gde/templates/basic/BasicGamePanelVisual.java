...
public class BasicGamePanelVisual extends JPanel implements DocumentListener {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(projectNameLabel, org.openide.util.NbBundle.getMessage(BasicGamePanelVisual.class, "BasicGamePanelVisual.projectNameLabel.text")); // NOI18N

        projectLocationLabel.setLabelFor(projectLocationTextField);
        org.openide.awt.Mnemonics.setLocalizedText(projectLocationLabel, org.openide.util.NbBundle.getMessage(BasicGamePanelVisual.class, "BasicGamePanelVisual.projectLocationLabel.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(browseButton, org.openide.util.NbBundle.getMessage(BasicGamePanelVisual.class, "BasicGamePanelVisual.browseButton.text")); // NOI18N
        browseButton.setActionCommand(org.openide.util.NbBundle.getMessage(BasicGamePanelVisual.class, "BasicGamePanelVisual.browseButton.actionCommand")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(createdFolderLabel, org.openide.util.NbBundle.getMessage(BasicGamePanelVisual.class, "BasicGamePanelVisual.createdFolderLabel.text")); // NOI18N
